      ...
      <main className="container mx-auto p-4">
        ...
        <section className="mt-8 flex justify-center">
          <div className="flex flex-col items-center">
            ...
            <iframe
              src="https://carbon.now.sh/embed?bg=rgba%28255%2C0%2C0%2C0%29&t=vscode&wt=none&l=application%2Fx-sh&width=677&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=false&pv=56px&ph=56px&ln=false&fl=1&fm=Hack&fs=14px&lh=133%25&si=false&es=2x&wm=false&code=%2524title%255BPong%21%255D%250A%2524description%255BYour%2520bot%2520is%2520%2524pingms%255D%250A%2524footer%255BAwesome%21%255D%250A%2524color%255B7C3AED%255D%250A%250A%250A%250A&tb=index.js"
